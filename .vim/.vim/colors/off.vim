...
let s:light_green     = { "gui": "#000080", "cterm": "10"  }
...
call s:h("Cursor",        {"bg": s:black, "fg": s:white })
call s:h("Comment",       {"fg": s:bg_subtle, "gui": "italic"})
call s:h("Blue",          {"bg": s:bg, "fg": s:light_green})
call s:h("Blue2",          {"bg": s:bg, "fg": s:light_green})
...
hi! link String           Blue2

"call s:h("Identifier",    {"fg": s:dark_blue})
hi! link Identifier       Normal
hi! link Function         Blue2
